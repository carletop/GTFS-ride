...
| stdev_boardings | **Condtionally Required** | The **stdev_boardings** field contains the average of all boardings for the identified service or stops for the period indicated. This field is required if **avg_boardings** is used. Non-negative float. |
| sampsize_boardings | **Condtionally Required** |  The **sampsize_boardings** field contains the count of observation in the sample used to calculate **avg_boardings** and **stdev_boardings**. This field is required if **avg_boardings** is used. Non-negative integer.  |
| avg_alightings | **Optional** | The **avg_boardings** field contains the average of all boardings for the identified service or stops for the period indicated. A record without a **stop_id** should have boath **avg_boardings** and **avg_alightings**, and they should be equal; a record with a **stop_id** must have at least one of the two. Non-negative float. |
| stdev_alightings | **Condtionally Required** | The **stdev_alightings** field contains the average of all alightings for the identified service or stops for the period indicated. This field is required if **avg_alightings** is used. Non-negative float. |
| sampsize_alightings | **Condtionally Required** | The **sampsize_alightings** field contains the count of observation in the sample used to calculate **avg_alightings** and **stdev_alightings**. This field is required if **avg_alightings** is used. Non-negative integer.  |
